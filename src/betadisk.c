...
int betadisk_check_if_rom_area(z80_int dir)
{
	...
	if (MACHINE_IS_TSCONF)
	{
		...
		if (tsconf_get_rom_bank() != 3)
			return 0; // Esto puede fallar si se gestiona "dos_signal" desde esa funcion de tsconf
